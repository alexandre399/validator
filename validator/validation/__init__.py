...
from validator.adapter import AdapterNotFoundError, adapt
...
def validate(rules: list[str] | None = None, mode: Mode = Mode.AND) -> Callable:
    ...
    def decorateur(function: Callable) -> Callable:
        ...
        def inner(self, *args: list, **kwargs: dict) -> object | None:  # noqa: ANN001
            ...
            return (
                ...
                if validator.accept(rules, mode, self, *args, **kwargs)
                else None
            )
